    ...
    <div class="user_info_card">
      <div>
        ...
        <div class="bind clear">
          <div :style="{color:lawyerStatus[0]!==undefined? lawyerStatus[0].color:'' }" @click="()=>{this.$router.push({path:'/usercenter/auth'})}">
            <i class="iconfont iconuser"/>
            <span>{{ lawyerStatus[0]!==undefined? lawyerStatus[0].displayName:'' }}</span>
          </div>
